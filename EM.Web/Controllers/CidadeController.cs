...
{
    public class CidadeController(CidadeRepository cidadeRepository, AlunoRepository alunoRepository) : Controller
    {
        private readonly CidadeRepository _repo = cidadeRepository;
